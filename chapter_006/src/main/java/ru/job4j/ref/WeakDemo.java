...
public class WeakDemo {
    ...
    /**
     * WeakReference в отличии от SoftReference удаляеться сразу
     * если не имеет стронг иили софт ссылок.
     * В методе за'null'ение сильной ссылки приводит к
     * удалению объекта и мы его также уже не можем получить
     * по слабой ссылке.
